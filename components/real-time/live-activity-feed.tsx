...
interface ActivityItem {
  ...
  action: string;
  category: string;
  details: { co2Saved: number; points: number };
  timestamp: Date;
}
        ...
        <div className="space-y-3">
                    ...
                    <div className="text-xs text-muted-foreground">
                      {activity.details.co2Saved && (
                        <span className="text-green-600 font-medium">
                          +{activity.details.co2Saved}kg CO2 saved
                        </span>
                      )}
                      {activity.details.points && (
                        <span className="ml-2 text-eco-primary font-medium">
          ...
          {displayActivities.length === 0 && (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-xs">
                Activity from your pod members will appear here
              </p>
            </div>
          )}
        </div>
