    ...
    switch (filter) {
      case "active":
        return {
          ...
          message:
            "You haven't joined any challenges yet. Browse available challenges to start your eco journey!",
      ...
      case "available":
        return {
          ...
          title: "All Caught Up!",
          message:
            "You've joined all available challenges. Check back soon for new sustainability adventures!",
