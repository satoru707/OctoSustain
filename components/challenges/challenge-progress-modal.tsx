...
export function ChallengeProgressModal({ isOpen, onClose, challenge }: ChallengeProgressModalProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
              <Progress value={Number.parseFloat(progress)} className="flex-1" />
          ...
          {/* Image Upload */}
          <div className="space-y-2">
            <label className="text-sm font-medium">Progress Photo (Optional)</label>
            <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4">
              {imagePreview ? (
                ...
                <label className="flex flex-col items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm text-muted-foreground">Click to upload progress photo</span>
          ...
          <div className="flex gap-2 justify-end">
            ...
            <Button type="submit" disabled={isSubmitting} className="bg-eco-primary hover:bg-eco-primary/90">
